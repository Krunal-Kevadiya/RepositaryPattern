...
interface PeopleService {
    ...
    fun fetchPopularPeople(@Query("page") page: Int): LiveData<SealedApiResult<PeopleResponse>>

    @GET("/3/person/{person_id}")
    fun fetchPersonDetail(@Path("person_id") id: Int): LiveData<SealedApiResult<PersonDetail>>
}
