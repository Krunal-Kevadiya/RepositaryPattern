...
interface TheDiscoverService {
    ...
    fun fetchDiscoverMovie(@Query("page") page: Int): LiveData<SealedApiResult<DiscoverMovieResponse, ErrorEnvelope>>

    @GET("/3/discover/tv?language=en&sort_by=popularity.desc")
    fun fetchDiscoverTv(@Query("page") page: Int): LiveData<SealedApiResult<DiscoverTvResponse, ErrorEnvelope>>
}
