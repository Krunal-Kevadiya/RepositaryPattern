...
interface TvService {
    ...
    fun fetchKeywords(@Path("tv_id") id: Int): LiveData<SealedApiResult<KeywordListResponse>>

    @GET("/3/tv/{tv_id}/videos")
    fun fetchVideos(@Path("tv_id") id: Int): LiveData<SealedApiResult<VideoListResponse>>

    @GET("/3/tv/{tv_id}/reviews")
    fun fetchReviews(@Path("tv_id") id: Int): LiveData<SealedApiResult<ReviewListResponse>>
}
